<template>
  <transition name="page_wrapper">
    <div class="page_wrapper">
      <div class="page74 page" v-show="pageStatus">
        <div class="page_content">
          <img class="page_bg" src="./page74.png" alt="">
          <goodjob
  ...
  let list = [
    {
      id: '2',
      className: 'choose_a',
      src: './static/page74/page74-3.png',
      index: '1'
    },
    {
      id: '3',
      className: 'choose_b',
      src: './static/page74/page74-4.png',
      index: '2'
    },
    {
      id: '4',
      className: 'choose_c',
      src: './static/page74/page74-2.png',
      index: '3'
    },
    {
      id: '1',
      className: 'choose_d',
      src: './static/page74/page74-8.png',
      index: '4'
    }
  ]
      ...
      checkAnswer(stage, poinsts) {
        if (this.checkOnOff && this.list2.length) {
          if (this.goToNextStatus === 1) {
            this.uploadResult(stage, poinsts, 'page74', true, '4')
          } else {
            this.uploadResult(stage, poinsts, 'page74', false, '4')
          }
          if (this.$refs.audio) {
